module "windows_function_app" {
  ...
  storage_account_name = module.storage_account_function_windows[0].name
  primary_access_key   = module.storage_account_function_windows[0].primary_key
...
module "linux_function_app" {
  ...
  storage_account_name = module.storage_account_function_linux[0].name
  primary_access_key   = module.storage_account_function_linux[0].primary_key
