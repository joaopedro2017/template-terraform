module "subnet_virtual_machine_windows" {
  ...
  prefix               = "${var.az_authentication["project"]}-${var.az_authentication["environment"]}-vm-windows"
...
module "subnet_virtual_machine_linux" {
  ...
  prefix               = "${var.az_authentication["project"]}-${var.az_authentication["environment"]}-vm-linux"
...
module "subnet_windows_virtual_machine_scale_set" {
  ...
  prefix               = "${var.az_authentication["project"]}-${var.az_authentication["environment"]}-vmss-windows"
...
module "subnet_linux_virtual_machine_scale_set" {
  ...
  prefix               = "${var.az_authentication["project"]}-${var.az_authentication["environment"]}-vmss-linux"
